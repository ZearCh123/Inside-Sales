...
import { NAV_GROUPS, activeGroup } from "@/lib/modules";
...
export function AppSidebar({
  ...
  return (
    <aside className="flex w-60 shrink-0 flex-col border-r border-border bg-brand-ink text-brand-paper print:hidden">
      ...
      <nav className="flex-1 space-y-1 px-3 py-2">
        {NAV_GROUPS.map((group) => {
          ...
          // Link to the section's first tab.
